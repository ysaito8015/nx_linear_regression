defmodule NxLinearRegression do
  ...
  defn init_random_params do
    w = Nx.Random.normal(Nx.Random.key(42), 0.0, 0.1)
    b = Nx.Random.normal(Nx.Random.key(42), 0.0, 0.1)
    {w, b}
  end

  # This is for training based on the number of epochs.
  @spec train(data :: tuple(), lr :: float(), epochs :: integer()) ::{Nx.Tensor.t(), Nx.Tensor.t()}
  ...
  # It's important to simulate how a model would perfom on new/unseen data.
